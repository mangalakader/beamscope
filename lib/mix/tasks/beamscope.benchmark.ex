defmodule Mix.Tasks.Beamscope.Benchmark do
  @moduledoc """
  Benchmarks beamscope against a real grep/read baseline, for one or more
  ...
  call graph (see `Beamscope.Benchmark.TaskDiscovery` — no hardcoded
  per-repo function names, works against any repo), measures real token
  counts for both the baseline and beamscope (`Beamscope.Benchmark.Tokenizer`
  ...
  @shortdoc "Benchmarks beamscope vs. a real grep/read baseline against repos of your choice"
