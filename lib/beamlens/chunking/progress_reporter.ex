defmodule Beamlens.Chunking.ProgressReporter do
  @moduledoc """
  ...
  @handler_id "beamlens-spike-progress-reporter"
  @events [
    [:beamlens, :chunk_repo, :start],
    [:beamlens, :chunk_repo, :file, :stop],
  ...
  def handle_event([:beamlens, :chunk_repo, :stop], measurements, metadata, _config) do
