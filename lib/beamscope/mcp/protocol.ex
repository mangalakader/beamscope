defmodule Beamscope.MCP.Protocol do
  @moduledoc """
  ...
  alias Beamscope.MCP.Tools.{FindCallPath, GetCallees, GetCallers, SearchCode}
  ...
  def handle(%{"method" => "initialize", "id" => id}) do
    ok(id, %{
      ...
      "capabilities" => %{"tools" => %{}},
      "serverInfo" => %{"name" => "beamscope", "version" => version()}
    })
  end
  ...
  defp version, do: to_string(Application.spec(:beamscope, :vsn))
end
