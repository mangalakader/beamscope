defmodule Beamscope.Callgraph.Pipeline do
  @moduledoc """
  ...
  alias Beamscope.Callgraph.{Extractor, Graph}
  ...
  def extract_repo(repo_path, opts \\ []) do
    ...
    :telemetry.execute(
      [:beamscope, :callgraph_repo, :start],
