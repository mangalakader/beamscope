defmodule Beamlens.MCP.Tools.SearchCodeTest do
  use ExUnit.Case, async: false

  alias Beamlens.MCP.Tools.SearchCode
  ...
  # Beamlens.Search.StoreExternalTest via the same singleton
  # Beamlens.Search.Store process. Deleting the on-disk .beamlens/ dir here
  ...
  # .beamlens/ is gitignored, so leaving it on disk between test runs is
