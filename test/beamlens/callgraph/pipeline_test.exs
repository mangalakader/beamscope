defmodule Beamlens.Callgraph.PipelineTest do
  ...
  setup do
    dir =
      Path.join(System.tmp_dir!(), "beamlens_pipeline_test_#{System.unique_integer([:positive])}")

    File.mkdir_p!(dir)

    File.write!(Path.join(dir, "good.ex"), """
    defmodule Beamlens.PipelineFixture do
      def hello, do: :world
    end
    """)
