defmodule Beamscope.Callgraph.ExtractorTest do
  use ExUnit.Case, async: true

  alias Beamscope.Callgraph.Extractor
  ...
  describe "Elixir extraction" do
    test "resolves a local call within the same module" do
      ...
      assert [
               %{
                 caller_module: "Beamscope.FakeSession",
                 caller_name: "resume",
                 callee_module: "Beamscope.FakeSession",
                 callee_name: "verify"
               }
             ] = edges
    end
    ...
    test "qualifies defs with their full nested module path" do
      ...
      assert Enum.any?(defs, &(&1.module == "Beamscope.FakeSession.Nested" and &1.name == "ping"))
    end
